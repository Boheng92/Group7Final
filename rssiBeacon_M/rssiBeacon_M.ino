...
XBeeAddress64 COORDINATOR64 = XBeeAddress64(0x0013A200, 0x40A1A183);
XBeeAddress64 XBEEZERO64 = XBeeAddress64(0x0013A200, 0x40A1A11D);
XBeeAddress64 XBEEOE64 = XBeeAddress64(0x0013A200, 0x40C84925);
XBeeAddress64 XBEETWO64 = XBeeAddress64(0x0013A200, 0x40C84905);
XBeeAddress64 XBEETHREE64 = XBeeAddress64(0x0013A200, 0x40A1A16D);
...
void processResponse()
{
  if (xbee.getResponse().isAvailable()) 
  {
    ...
    if (xbee.getResponse().getApiId() == ZB_RX_RESPONSE) 
    {
      ...
      XBeeAddress64 replyAddress = COORDINATOR64;
